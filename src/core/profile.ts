...
export const cheapProfile: Profile = {
  ...
  classes: {
    ...
    standard: { model: "sonnet", effort: "low", tools: "default", maxBudgetUsd: 0.5, maxOutputTokens: 2000 },
...
export const qualityProfile: Profile = {
  ...
  classes: {
    ...
    simple: { model: "sonnet", effort: "medium", tools: "default", maxBudgetUsd: 0.5, maxOutputTokens: 500 },
    standard: { model: "sonnet", effort: "high", tools: "default", maxBudgetUsd: 2.0, maxOutputTokens: 2000 },
